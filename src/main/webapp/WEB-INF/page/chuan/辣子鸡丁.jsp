...
<div class="row col-lg-8 col-lg-offset-2 col-xs-8 col-xs-offset-2 distance">
    ...
    <fieldset class="ingredients">
        <legend>小诀窍</legend>
        <ul>
            <li>1.做川菜时经常用到菜籽油，所以菜籽油一定要煎熟，不然就会有生油的味道，很多人接受不了  </li>
            <li>2.辣椒选择二荆条干辣椒，基本不辣，但是辣椒味很香  </li>
            <li>3.炒辣椒的时候可以根据个人口感选择糊香味还是酥香味的辣椒，糊香味就是辣椒炒的时间比较长，成了糊辣壳了（重庆的一种叫法）；不喜欢糊 </li>
        </ul>
    </fieldset>
